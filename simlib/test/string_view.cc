...
TEST(DISABLED_StringBase, default_constructor) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_nullptr) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_const_char_array) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_char_array) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_const_StaticCStringBuff) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_char_ptr) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_char_ptr_with_size) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_temporary_string) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_temporary_const_string) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_const_string_ref) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, constructor_from_string_ref) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, copy_constructor) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, move_constructor) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, copy_assignment) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, move_assignment) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, assignment_from_nullptr) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, empty) {
	// TODO: implement it
}

TEST(DISABLED_StringBase, size) {
	// TODO: implement it
}
...
TEST(DISABLED_StringView, default_constructor) {
	// TODO: implement it
}

TEST(DISABLED_StringView, constructor_from_nullptr) {
	// TODO: implement it
}
