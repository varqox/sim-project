...
// NOLINTNEXTLINE
TEST(StringBase, default_constructor) { EXPECT_EQ(StringBase<char>{}.size(), 0); }
...
TEST(StringBase, constructor_from_temporary_const_string) {
    ...
    EXPECT_FALSE((std::is_constructible_v<StringBase<char>, const string&&>));
    EXPECT_FALSE((std::is_constructible_v<StringBase<const char>, const string>));
    EXPECT_FALSE((std::is_constructible_v<StringBase<const char>, const string&&>));
}
...
TEST(StringBase, assignment_from_nullptr) {
    ...
    EXPECT_FALSE((std::is_assignable_v<StringBase<const char>, std::nullptr_t>));
}
...
// NOLINTNEXTLINE
TEST(DISABLED_StringBase, find_with_beg_and_end_and_StringBase_and_beg_and_end) {
    // TODO: implement it
}
...
// NOLINTNEXTLINE
TEST(DISABLED_StringBase, rfind_with_beg_and_end_and_StringBase_and_beg_and_end) {
    // TODO: implement it
}
