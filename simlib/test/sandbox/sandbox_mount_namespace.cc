...
TEST(sandbox, no_operations_new_root_mount_path) {
    ...
    // pivot_root() fails
    ASSERT_RESULT_ERROR(
        sc.await_result(), "pid1: pivot_root(\".\", \".\") - Invalid argument (os error 22)"
    );
}
            ...
            .linux_namespaces =
                {
                    .mount =
                        {
                            .operations = {{
                                MountTmpfs{.path = "/", .inode_limit = nullopt, .read_only = false},
                                CreateDir{.path = "/../usr"},
                                BindMount{
                                    .source = "/usr",
                                    .dest = "/../usr",
                    ...
                    .mount =
                        {
                            .operations = {{
                                ...
                                CreateDir{.path = "/tmp/max_total_size_of_files_nullopt"},
                                MountTmpfs{
                                    .path = "/tmp/max_total_size_of_files_nullopt",
                                    .max_total_size_of_files_in_bytes = std::nullopt,
                                    .inode_limit = nullopt,
                                    .read_only = false,
                                },
                                CreateDir{.path = "/tmp/max_total_size_of_files_0"},
                                MountTmpfs{
                                    .path = "/tmp/max_total_size_of_files_0",
                                    .max_total_size_of_files_in_bytes = 0,
                                    .inode_limit = nullopt,
                                    .read_only = false,
                                },
                                CreateDir{.path = "/tmp/max_total_size_of_files_1"},
                                MountTmpfs{
                                    .path = "/tmp/max_total_size_of_files_1",
                                    .max_total_size_of_files_in_bytes = 1,
                                    .inode_limit = nullopt,
                                    .read_only = false,
                                },
                                CreateDir{.path = "/tmp/max_total_size_of_files_32768"},
                                MountTmpfs{
                                    .path = "/tmp/max_total_size_of_files_32768",
                                    .max_total_size_of_files_in_bytes = 32768,
                                    .inode_limit = nullopt,
                                    .read_only = false,
                                },
                                CreateDir{.path = "/tmp/inode_limit_nullopt"},
                                MountTmpfs{
                                    .path = "/tmp/inode_limit_nullopt",
                                    .inode_limit = nullopt,
                                    .read_only = false,
                                },
                                CreateDir{.path = "/tmp/inode_limit_0"},
                                MountTmpfs{
                                    .path = "/tmp/inode_limit_0",
                                    .inode_limit = 0,
                                    .read_only = false,
                                },
                                CreateDir{.path = "/tmp/inode_limit_1"},
                                MountTmpfs{
                                    .path = "/tmp/inode_limit_1",
                                    .inode_limit = 1,
                                    .read_only = false,
                                },
                                CreateDir{.path = "/tmp/inode_limit_2"},
                                MountTmpfs{
                                    .path = "/tmp/inode_limit_2",
                                    .inode_limit = 2,
                                    .read_only = false,
                                },
                                CreateDir{.path = "/tmp/root_dir_mode_0000"},
                                MountTmpfs{
                                    .path = "/tmp/root_dir_mode_0000",
                                    .root_dir_mode = 0000,
                                },
                                CreateDir{.path = "/tmp/root_dir_mode_0123"},
                                MountTmpfs{
                                    .path = "/tmp/root_dir_mode_0123",
                                    .root_dir_mode = 0123,
                                },
...
TEST(sandbox, create_existing_dir_fails) {
    ...
    ASSERT_RESULT_ERROR(sc.await_result(), "pid1: mkdir(\"/tmp/dir\") - File exists (os error 17)");
}
...
TEST(sandbox, creating_existing_file_fails) {
    ...
    ASSERT_RESULT_ERROR(
        sc.await_result(), "pid1: open(\"/tmp/file\", O_CREAT | O_EXCL) - File exists (os error 17)"
    );
}
