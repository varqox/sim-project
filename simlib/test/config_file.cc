...
workers: "2" # [103,104)
	...
	// use it here
	EXPECT_THROW(cf.load_config_from_string("a & eee "),
	...
	EXPECT_THROW(cf.load_config_from_string("a = 'b\nb'"),
	             ConfigFile::ParseError);
	EXPECT_THROW(cf.load_config_from_string("a = 'b'b'"),
	             ConfigFile::ParseError);
	EXPECT_THROW(cf.load_config_from_string("a = \"b\"b\""),
	             ConfigFile::ParseError);
	EXPECT_THROW(cf.load_config_from_string("a = \"\\q\""),
	             ConfigFile::ParseError);
	EXPECT_THROW(cf.load_config_from_string("a = a\n\n&"),
	             ConfigFile::ParseError);
	EXPECT_THROW(cf.load_config_from_string("a = a\n\na = '"),
	             ConfigFile::ParseError);
	EXPECT_THROW(cf.load_config_from_string("a = \"\\xg21\""),
	             ConfigFile::ParseError);
	EXPECT_THROW(cf.load_config_from_string("a = \"\\x2g1\""),
	             ConfigFile::ParseError);
	EXPECT_THROW(cf.load_config_from_string("a = \"\\x\""),
	             ConfigFile::ParseError);
	EXPECT_THROW(cf.load_config_from_string("a = \"\\xa\""),
	             ConfigFile::ParseError);
