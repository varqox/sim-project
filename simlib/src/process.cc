...
void kill_processes_by_exec(
    vector<string> exec_set, optional<duration<double>> wait_timeout, bool kill_after_waiting,
    ...
    // is already dead
    constexpr uint START_TIME_FID = 21; // Number of the field in /proc/[pid]/stat that
