...
#define FOLDR(macro, seq, ...)                                                  \
    IMPL_FOLDR_EXTRACT_RES(EXPAND(EXPAND(IMPL_FOLDR_PREPARE_PREFIX(seq) DEFER2( \
        IMPL_FOLDR_EVAL_USING_START)(macro, __VA_ARGS__) IMPL_FOLDR_PREPARE_SUFFIX(seq))))
...
#define IMPL_FOLDR_PREPARE_SUFFIX_1(...) \
    IMPL_FOLDR_PREPARE_SUFFIX_3 IMPL_FOLDR_PREPARE_SUFFIX_2
#define IMPL_FOLDR_PREPARE_SUFFIX_2(...) \
    IMPL_FOLDR_PREPARE_SUFFIX_3 IMPL_FOLDR_PREPARE_SUFFIX_1
...
#define MAP_DELIM_FUNC(macro, delimiter_func, seq) \
    IMPL_MAP_DELIM_FUNC(                           \
        macro, delimiter_func, FOLDR(IMPL_MAP_DELIM_FUNC_SPLIT_FIRST_ARG, seq, , ))
