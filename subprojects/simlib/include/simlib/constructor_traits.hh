...
template <class T, class... Args>
constexpr inline bool is_implicitly_constructible_v = std::is_constructible_v<T, Args...> and
    decltype(detail::test_implicitly_constructible<T, Args...>(0))::value;

template <class ConstructorClass, class... ConstructorArgs>
constexpr inline bool is_constructor_ok =
    !((sizeof...(ConstructorArgs) == 1) and ... and
