...
http::Response
regenerate(web_worker::Context& ctx, decltype(sim::contests::Contest::id) contest_id);
...
http::Response
regenerate_short(web_worker::Context& ctx, decltype(sim::contests::Contest::id) contest_id);
