...
int main(int argc, char **argv) {
	...
	try_to_create_table("users",
		concat("CREATE TABLE IF NOT EXISTS `users` ("
			...
			"`username` varchar(", USERNAME_MAX_LEN, ") NOT NULL,"
			"`first_name` varchar(", USER_FIRST_NAME_MAX_LEN, ") NOT NULL,"
			"`last_name` varchar(", USER_LAST_NAME_MAX_LEN, ") NOT NULL,"
			"`email` varchar(", USER_EMAIL_MAX_LEN, ") NOT NULL,"
			"`salt` char(", SALT_LEN, ") NOT NULL,"
			"`password` char(", PASSWORD_HASH_LEN, ") NOT NULL,"
	...
	try_to_create_table("session",
		concat("CREATE TABLE IF NOT EXISTS `session` ("
			"`id` char(", SESSION_ID_LEN, ") NOT NULL,"
			"`csrf_token` char(", SESSION_CSRF_TOKEN_LEN, ") NOT NULL,"
	...
	try_to_create_table("problems",
		concat("CREATE TABLE IF NOT EXISTS `problems` ("
			...
			"`name` VARCHAR(", PROBLEM_NAME_MAX_LEN, ") NOT NULL,"
			"`label` VARCHAR(", PROBLEM_LABEL_MAX_LEN, ") NOT NULL,"
	...
	try_to_create_table("problems_tags",
		concat("CREATE TABLE IF NOT EXISTS `problems_tags` ("
			...
			"`tag` VARCHAR(", PROBLEM_TAG_MAX_LEN, ") NOT NULL,"
	...
	try_to_create_table("rounds",
		concat("CREATE TABLE IF NOT EXISTS `rounds` ("
			...
			"`name` VARCHAR(", ROUND_NAME_MAX_LEN, ") NOT NULL,"
			"`owner` int unsigned NOT NULL,"
	...
	try_to_create_table("files",
		concat("CREATE TABLE IF NOT EXISTS `files` ("
			"`id` char(", FILE_ID_LEN, ") NOT NULL,"
			"`round_id` int unsigned NULL,"
			"`name` VARCHAR(", FILE_NAME_MAX_LEN, ") NOT NULL,"
			"`description` VARCHAR(", FILE_DESCRIPTION_MAX_LEN, ") "
				"NOT NULL,"
