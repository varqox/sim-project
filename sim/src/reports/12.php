...
template_begin('Zgłoszenie 12',$user);

if(isset($_GET['source']))
{
echo '<div style="margin: 60px 50px">', shell_exec($_SERVER['DOCUMENT_ROOT']."/judge/CTH ".$_SERVER['DOCUMENT_ROOT']."/solutions/12.cpp"), '
</div>';
template_end();
exit;
}
...
<p style="padding: 15px 0 0 200px;font-size: 35px;text-align: left">Zgłoszenie 12</p>
...
<tr>
  ...
  <td class="ok">OK</td>
  <td>0.00/1.00</td>
  <td rowspan="5" class="groupscore">10/10</td>
</tr>
<tr>
  <td>bar1b</td>
  <td class="ok">OK</td>
...
<tr>
  ...
  <td class="ok">OK</td>
  <td>0.01/1.00</td>
  <td rowspan="3" class="groupscore">10/10</td>
</tr>
<tr>
  <td>bar2b</td>
  <td class="ok">OK</td>
...
<tr>
  ...
  <td class="ok">OK</td>
  <td>0.09/1.00</td>
  <td rowspan="4" class="groupscore">10/10</td>
</tr>
<tr>
  <td>bar3b</td>
  <td class="ok">OK</td>
...
<tr>
  ...
  <td class="ok">OK</td>
  <td>0.24/1.00</td>
  <td rowspan="2" class="groupscore">10/10</td>
</tr>
<tr>
  <td>bar5b</td>
  <td class="ok">OK</td>
