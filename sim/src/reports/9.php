...
{header('Content-type: application/text');header('Content-Disposition: attchment; filename="9.cpp"');readfile($_SERVER['DOCUMENT_ROOT']."/solutions/9.cpp");exit;}

$user="none";
require_once $_SERVER['DOCUMENT_ROOT']."/kit/main.php";

template_begin('Zgłoszenie 9',$user);

if(isset($_GET['source']))
{
echo '<div style="margin: 60px 50px">', shell_exec($_SERVER['DOCUMENT_ROOT']."/judge/CTH ".$_SERVER['DOCUMENT_ROOT']."/solutions/9.cpp"), '
</div>';
template_end();
exit;
}
...
<p style="padding: 15px 0 0 200px;font-size: 35px;text-align: left">Zgłoszenie 9</p>
