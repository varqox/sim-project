...
OverallPermissions
get_overall_permissions(optional<User::Type> user_type) noexcept {
	...
	case User::Type::TEACHER:
		return PERM::ADD | PERM::VIEW_WITH_TYPE_PUBLIC |
		       PERM::VIEW_WITH_TYPE_CONTEST_ONLY | PERM::SELECT_BY_OWNER;
...
Permissions get_permissions(optional<decltype(User::id)> user_id,
	...
	constexpr PERM admin_perms =
	   PERM::VIEW | PERM::VIEW_STATEMENT | PERM::VIEW_TAGS |
	...
	case User::Type::TEACHER: {
		...
		case Problem::Type::CONTEST_ONLY:
			return PERM::VIEW | PERM::VIEW_STATEMENT | PERM::VIEW_TAGS |
			       PERM::VIEW_HIDDEN_TAGS | PERM::VIEW_SIMFILE |
