...
class Sim final {
    ...
    MySQL::Connection mysql = MySQL::make_conn_with_credential_file(".db.config");
    ...
    void api_job_download_uploaded_package(std::optional<uint64_t> file_id, JobType job_type);
    ...
    void api_problem_download(StringView problem_label, sim::problem::Permissions perms);
    ...
    void api_problem_attaching_contest_problems(sim::problem::Permissions perms);
    ...
    void
    api_contest_edit(StringView contest_id, sim::contest::Permissions perms, bool is_public);

    void api_contest_delete(StringView contest_id, sim::contest::Permissions perms);

    void api_contest_round_create(StringView contest_id, sim::contest::Permissions perms);

    void api_contest_round_clone(StringView contest_id, sim::contest::Permissions perms);

    void api_contest_round_edit(uintmax_t contest_round_id, sim::contest::Permissions perms);

    void api_contest_round_delete(uintmax_t contest_round_id, sim::contest::Permissions perms);
    ...
    void
    api_contest_problem_edit(StringView contest_problem_id, sim::contest::Permissions perms);

    void
    api_contest_problem_delete(StringView contest_problem_id, sim::contest::Permissions perms);
    ...
    void
    api_contest_file_edit(StringView contest_file_id, sim::contest_file::Permissions perms);

    void
    api_contest_file_delete(StringView contest_file_id, sim::contest_file::Permissions perms);
...
private:
    ...
    std::pair<std::optional<sim::ContestUser::Mode>, Sim::ContestUserPermissions>
    contest_user_get_overall_permissions(StringView contest_id);

    // Returns (viewer mode, perms, user's mode), queries MySQL
    std::tuple<
        std::optional<sim::ContestUser::Mode>, Sim::ContestUserPermissions,
