...
constexpr unsigned TMP_SESSION_MAX_LIFETIME = 60 * 60; // 1 hour [s]
constexpr unsigned SESSION_MAX_LIFETIME = 30 * 24 * 60 * 60; // 30 days [s]

// Problems
constexpr unsigned NEW_STATEMENT_MAX_SIZE = 10 << 20; // 10 MiB

// Problems' tags
constexpr unsigned PROBLEM_TAG_MAX_LEN = 128;

// Contest entry tokens
constexpr unsigned CONTEST_ENTRY_TOKEN_LEN = 48;
constexpr unsigned CONTEST_ENTRY_SHORT_TOKEN_LEN = 8;
constexpr unsigned CONTEST_ENTRY_SHORT_TOKEN_MAX_LIFETIME = 60 * 60; // 1 hour [s]

// Files
constexpr unsigned FILE_ID_LEN = 30;
constexpr unsigned FILE_NAME_MAX_LEN = 128;
constexpr unsigned FILE_DESCRIPTION_MAX_LEN = 512;
constexpr unsigned FILE_MAX_SIZE = 128 << 20; // 128 MiB
...
constexpr unsigned priority(JobType x) {
    using JT = JobType;
    switch (x) {
...
// Jobs
constexpr unsigned JOB_LOG_VIEW_MAX_LENGTH = 128 << 10; // 128 KiB
...
// API
constexpr unsigned API_FIRST_QUERY_ROWS_LIMIT = 50;
constexpr unsigned API_OTHER_QUERY_ROWS_LIMIT = 200;
