...
public:
    ...
    template <class... Args,
            std::enable_if_t<is_inheriting_implicit_constructor_ok<SatisfyingPredicate,
                                     SqlField, Args&&...>,
                    int> = 0>
    // NOLINTNEXTLINE(google-explicit-constructor)
    SatisfyingPredicate(Args&&... args)
    : SqlField{std::forward<Args>(args)...} {}

    template <class... Args,
            std::enable_if_t<is_inheriting_explicit_constructor_ok<SatisfyingPredicate,
                                     SqlField, Args&&...>,
                    int> = 0>
    explicit SatisfyingPredicate(Args&&... args)
    : SqlField{std::forward<Args>(args)...} {}
...
template <class SqlField, bool (*predicate_func)(const SqlField&), const char* description_str>
constexpr inline bool is_satisfying_predicate<
        SatisfyingPredicate<SqlField, predicate_func, description_str>> = true;
